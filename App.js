...
export default function App() {
  ...
  const handleDocumentPicker = async () => {
    ...
    if (result?.mimeType === "audio/mpeg" || result?.mimeType === "video/mp4") {
      Alert.alert(
        "Warning",
        "Can't select this file as it is not a document.",
        [
          {
            text: "Cancel",
            style: "cancel",
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonBox}>
        <Button title="save" onPress={() => {}} style={styles.button} />
        <Button title="cancel" onPress={onReset} style={styles.button} />
      </View>
    </View>
  );
}
